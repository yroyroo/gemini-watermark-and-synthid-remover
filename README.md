...
A fast C++20 command-line tool that removes **visible** and **invisible** watermarks from images and videos generated by Google **Gemini**, **Veo**, and **NotebookLM**. One self-contained binary, no runtime dependencies.
